...
Hybrid profit-taking is now the default shipped paper profile: sell 75% at
28% net return on allocated cost; keep 25% for a 50% target or resolution.
Keep the 50 pUSD capital ceiling, 25% reserve, 5 pUSD order cap, five-position
cap, 5 pUSD realized-loss breaker, 10% drawdown breaker, and per-market
two-provider gate. Complete sets, live trading, and account reads remain off.
...
The earlier research used two isolated public-data-only paper campaigns:
